    ...
    <div className="bg-secondary lg:-mx-32 px-4 lg:px-32 pt-14">
        <div className="grid grid-flow-row md:grid-cols-2">
            ...
            <motion.div initial={{ scale: 0.4 }} whileInView={{ scale: 1, transition: { duration: 2}}} className="space-y-1 lg:space-y-4 bg-tertiary backdrop-blur-sm mt-8 p-4 lg:p-10 rounded-2xl ml-14">
                <div className="grid grid-cols-4 md:font-bold text-xs md:text-sm">
                    <p></p>
                    <p>Price</p>
                    <p>Change</p>
                    <p>Volume(24h)</p>
                ...
                <div className="grid grid-cols-4 items-center font-bold text-sm leading-0 lg:leading-5">
                    <div className="flex space-x-2 lg:space-x-4">
                        <Bitcoin className="w-5 md:w-8 md:h-8 lg:w-full lg:h-full"/>
                        <div>
                            <p className="font-medium md:font-semibold lg:font-bold text-sm md:text-base lg:text-xl">BTC</p>
                            <p className="font-thin lg:font-light text-xs md:text-base text-lightText">Bitcoin</p>
                        </div>
                    </div>
                    <p className="text-xs md:text-base font-thin text-lightText">$6750</p>
                    <p className="text-xs md:text-base font-thin text-lightBlue"><span className="inline-flex bg-lightBlue/10 rounded-full items-center justify-center p-1 pr-2"><Caretup/></span>+7.3%</p>
                    <p className="text-xs md:text-base font-thin text-lightText">$3420214</p>
                </div>
                <div className="grid grid-cols-4 items-center font-bold text-sm lg:leading-5 bg-darkBlue rounded-2xl -mx-10 px-5 lg:px-10 py-2 lg:py-5 -translate-x-10 lg:-translate-x-20">
                    <div className="flex space-x-2 lg:space-x-4">
                        <Ethereum className="w-5 md:w-8 md:h-8 lg:w-full lg:h-full"/>
                        <div className="">
                            <p className="font-medium md:font-semibold lg:font-bold text-sm md:text-base lg:text-xl">ETH</p>
                            <p className="font-thin lg:font-light text-xs md:text-base text-lightText">Ethereum</p>
                        </div>
                    </div>
                    <p className="text-xs md:text-base font-thin text-lightText">$6750</p>
                    <p className="text-xs md:text-base font-thin text-lightBlue"><span className="inline-flex bg-lightBlue/10 rounded-full items-center justify-center p-1 pr-2"><Caretup/></span>+7.3%</p>
                ...
                <div className="grid grid-cols-4 items-center font-bold text-sm leading-0 lg:leading-5">
                    <div className="flex space-x-2 lg:space-x-4">
                        <Lite className="w-5 md:w-8 md:h-8 lg:w-full lg:h-full"/>
                        <div>
                            <p className="font-medium md:font-semibold lg:font-bold text-sm md:text-base lg:text-xl">LTC</p>
                            <p className="font-thin lg:font-light text-xs md:text-base text-lightText">Litecoin</p>
                        </div>
                    </div>
                    <p className="text-xs md:text-base font-thin text-lightText">$6750</p>
                    <p className="text-xs md:text-base font-thin text-lightBlue"><span className="inline-flex bg-lightBlue/10 rounded-full items-center justify-center p-1 pr-2"><Caretup/></span>+7.3%</p>
