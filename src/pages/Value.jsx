...
function Value() {
  ...
  return (  
        <div className="bg-grey5 px-10 lg:px-32 pb-20 lg:-mx-32 z-20 pt-40">
            <div className="mt-[100px mt-16 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-flow-row sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-14">
                    {cards.map((card, idx) => (
