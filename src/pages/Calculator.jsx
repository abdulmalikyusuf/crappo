...
function Calculator() {
  ...
  return (
    <motion.div className="flex flex-col justify-center translate-y-1/3 -mt-42" initial="offscreen" whileInView="onscreen">
        <motion.div className="space-y-4 lg:space-y-6 text-center" variants={cardVariants}>
        ...
        <motion.div variants={cardVariants} className="z-40">
            <div className="grid grid-flow-row gap-10 rounded-2xl mx-4 lg:mx-32 p-8 lg:p-12 bg-[#FBFCFE] mt-8 lg:mt-14">
                ...
                <div className="text-black">
                    ...
                    <h2 className="mt-4 mb-1 font-bold text-2xl lg:text-[32px] lg:leading-[48px]">0.055 130 59 ETH <span className="text-accent">($1275)</span></h2>
                    <p className="lg:leading-7 text-grey">Revenue will change based on mining difficulty and Ethereum price.</p>
                </div>
